...
@Component({
 selector: 'app-claim',
 standalone: true,
 imports: [CommonModule, ReactiveFormsModule, ClarityModule, HeaderComponent],
...
export class ClaimformComponent implements OnInit {
 ...
 populateEmployeeFields() {
   if (this.employeeData) {
     this.claimForm.patchValue({
       ...
       // purposePlace and companyPlant — user fills these
     });
   }
 }
 ...
 submitForm() {
   ...
   if (this.claimForm.invalid) {
     console.log('Form is invalid:', this.claimForm.value);
     return;
   }
   const employeeId = localStorage.getItem('employeeId');
...
console.log("FINAL PAYLOAD:", JSON.stringify(Employeedetail));
